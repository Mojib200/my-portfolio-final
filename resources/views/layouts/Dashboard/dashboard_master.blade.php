                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('homes.index') }}">View Home</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('contact.index') }}">View Contact</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('protfolio.create') }}">Add Protfolio</a></li>
                            <li><a href="{{ route('protfolio.index') }}">View Protfolio</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('about.index') }}">View About</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        <i class="fa-solid fa-message"></i>
                        <span class="nav-text">Castomer Message</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{ route('castomer.index') }}">View Castomer</a></li>
                    </ul>
                </li>
